...
2. 打开Aqara APP，单击“新用户注册”按钮，输入手机号或邮箱，获取验证码后，单击“下一步”。
   ...
   > 说明：Aqara APP支持绑定微信和Facebook，若手机安装了微信或Facebook，会出现对应图标。
...
Aqara产品包括网关、控制器、传感器三大类。网关类设备是用于连接与管理多个智能传感器和控制器的中心枢纽。控制类设备是根据指令产生各种操作控制信号，来协调和指挥整个系统的操作。传感类设备是通过温度、湿度、光敏、位移等感知功能，来实现自动检测和自动控制。详细产品参数和功能介绍，请参见“产品介绍”手册。
...
> 注意：
>
> - 火线一般是红色的，灯具负载线一般为绿色或黄色，建议由专业电工使用电笔等专业工具测试后再安装。墙壁开关（单火双键版） 有3个接线孔，L、L1、L2；L接入的是火线，L1和L2分别接入灯具的负载线。
>
...
轨道与电机安装指导，请参考[智能窗帘点击安装教程](https://www.aqara.com/cn/videointroduce.html )。
...
- IOS版手机
  ...
  选择待连接的Wi-Fi，输入密码，单击“下一步”，按手机页面提示连接Wi-Fi后，单击左上角”返回Aqara App“。
...
2. 单击右上角的”+“，可选择使用系统推荐的自动化或创建自定义自动化：
   ...
   - 创建自定义自动化
     ...
     单击页面下方的”创建自定义自动化“，输入”自动化名称“，单击”+“设置条件和执行动作。
