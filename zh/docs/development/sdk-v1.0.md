...
2、根据[云端开发手册](http://docs.opencloud.aqara.com/zh/development/oauth-cloud-development/)中“OAuth 2.0”章节和API，获取openID和positionId。
...
>
> 3、调用接口时，可能获得正确或错误的返回结果，可参考[云端开发手册](http://docs.opencloud.aqara.com/zh/development/oauth-cloud-development/)中“返回码说明”章节排查错误。
